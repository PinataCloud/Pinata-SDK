import queryBuilder from './../../../../src/commands/data/userPinList/queryBuilder';

const baseUrl = 'testing.com/test';
const badFilterValue = 'badFilterValue';
const noFiltersUrl = `${baseUrl}/hashContains/*/pinStart/*/pinEnd/*/unpinStart/*/unpinEnd/*/pinSizeMin/*/pinSizeMax/*/pinFilter/*/pageLimit/10/pageOffset/0`;
...
describe('queryBuilder filter: hashContains', () => {
    ...
    test('string value is provided', () => {
        ...
        expect(queryBuilder(baseUrl, filters)).toEqual(`${baseUrl}/hashContains/test/pinStart/*/pinEnd/*/unpinStart/*/unpinEnd/*/pinSizeMin/*/pinSizeMax/*/pinFilter/*/pageLimit/10/pageOffset/0`);
    });
});
...
describe('queryBuilder filter: pinStart', () => {
    ...
    test('date value is provided', () => {
        ...
        expect(queryBuilder(baseUrl, filters)).toEqual(`${baseUrl}/hashContains/*/pinStart/${validISODate}/pinEnd/*/unpinStart/*/unpinEnd/*/pinSizeMin/*/pinSizeMax/*/pinFilter/*/pageLimit/10/pageOffset/0`);
    });
});
...
describe('queryBuilder filter: pinEnd', () => {
    ...
    test('date value is provided', () => {
        ...
        expect(queryBuilder(baseUrl, filters)).toEqual(`${baseUrl}/hashContains/*/pinStart/*/pinEnd/${validISODate}/unpinStart/*/unpinEnd/*/pinSizeMin/*/pinSizeMax/*/pinFilter/*/pageLimit/10/pageOffset/0`);
    });
});
...
describe('queryBuilder filter: unpinStart', () => {
    ...
    test('date value is provided', () => {
        ...
        expect(queryBuilder(baseUrl, filters)).toEqual(`${baseUrl}/hashContains/*/pinStart/*/pinEnd/*/unpinStart/${validISODate}/unpinEnd/*/pinSizeMin/*/pinSizeMax/*/pinFilter/*/pageLimit/10/pageOffset/0`);
    });
});
...
describe('queryBuilder filter: unpinEnd', () => {
    ...
    test('date value is provided', () => {
        ...
        expect(queryBuilder(baseUrl, filters)).toEqual(`${baseUrl}/hashContains/*/pinStart/*/pinEnd/*/unpinStart/*/unpinEnd/${validISODate}/pinSizeMin/*/pinSizeMax/*/pinFilter/*/pageLimit/10/pageOffset/0`);
    });
});
...
describe('queryBuilder filter: pinSizeMin', () => {
    ...
    test('date value is provided', () => {
        ...
        expect(queryBuilder(baseUrl, filters)).toEqual(`${baseUrl}/hashContains/*/pinStart/*/pinEnd/*/unpinStart/*/unpinEnd/*/pinSizeMin/${validInteger}/pinSizeMax/*/pinFilter/*/pageLimit/10/pageOffset/0`);
    });
});
...
describe('queryBuilder filter: pinSizeMax', () => {
    ...
    test('date value is provided', () => {
        ...
        expect(queryBuilder(baseUrl, filters)).toEqual(`${baseUrl}/hashContains/*/pinStart/*/pinEnd/*/unpinStart/*/unpinEnd/*/pinSizeMin/*/pinSizeMax/${validInteger}/pinFilter/*/pageLimit/10/pageOffset/0`);
    });
});

describe('queryBuilder filter: pinFilter', () => {
    test('non accepted value is passed in', () => {
        ...
        expect(() => {
            queryBuilder(baseUrl, filters);
        }).toThrow('pinFilter value must be either: all, pinned, or unpinned');
    });
    test('valid pinFilter is provided', () => {
        const validInput = 'pinned';
        const filters = {
            pinFilter: validInput
        };
        expect(queryBuilder(baseUrl, filters)).toEqual(`${baseUrl}/hashContains/*/pinStart/*/pinEnd/*/unpinStart/*/unpinEnd/*/pinSizeMin/*/pinSizeMax/*/pinFilter/${validInput}/pageLimit/10/pageOffset/0`);
    });
});
...
describe('queryBuilder filter: pageLimit', () => {
    ...
    test('Decimal is passed in - expect to round down', () => {
        ...
        expect(queryBuilder(baseUrl, filters)).toEqual(`${baseUrl}/hashContains/*/pinStart/*/pinEnd/*/unpinStart/*/unpinEnd/*/pinSizeMin/*/pinSizeMax/*/pinFilter/*/pageLimit/500/pageOffset/0`);
    ...
    test('valid pageLimit is provided', () => {
        ...
        expect(queryBuilder(baseUrl, filters)).toEqual(`${baseUrl}/hashContains/*/pinStart/*/pinEnd/*/unpinStart/*/unpinEnd/*/pinSizeMin/*/pinSizeMax/*/pinFilter/*/pageLimit/${validInput}/pageOffset/0`);
    });
});
...
describe('queryBuilder filter: pageOffset', () => {
    ...
    test('Decimal is passed in - expect to round down', () => {
        ...
        expect(queryBuilder(baseUrl, filters)).toEqual(`${baseUrl}/hashContains/*/pinStart/*/pinEnd/*/unpinStart/*/unpinEnd/*/pinSizeMin/*/pinSizeMax/*/pinFilter/*/pageLimit/10/pageOffset/500`);
    ...
    test('valid pageOffset is provided', () => {
        ...
        expect(queryBuilder(baseUrl, filters)).toEqual(`${baseUrl}/hashContains/*/pinStart/*/pinEnd/*/unpinStart/*/unpinEnd/*/pinSizeMin/*/pinSizeMax/*/pinFilter/*/pageLimit/10/pageOffset/${validInput}`);
    });
});
...
describe('metadata provided', () => {
    ...
    test('metadata name value provided', () => {
        ...
        expect(queryBuilder(baseUrl, filters)).toEqual(`${baseUrl}/hashContains/*/pinStart/*/pinEnd/*/unpinStart/*/unpinEnd/*/pinSizeMin/*/pinSizeMax/*/pinFilter/*/pageLimit/10/pageOffset/0?metadata[name]=${name}`);
    });
    ...
    test('Pass in a valid keyvalue object', () => {
        ...
        expect(queryBuilder(baseUrl, filters)).toEqual(`${baseUrl}/hashContains/*/pinStart/*/pinEnd/*/unpinStart/*/unpinEnd/*/pinSizeMin/*/pinSizeMax/*/pinFilter/*/pageLimit/10/pageOffset/0?metadata[keyvalues]=${query}`);
    });
    ...
    test('Pass in a valid name and keyvalue object with a secondValue', () => {
        ...
        const query = JSON.stringify(filters.metadata.keyvalues);
        expect(queryBuilder(baseUrl, filters)).toEqual(`${baseUrl}/hashContains/*/pinStart/*/pinEnd/*/unpinStart/*/unpinEnd/*/pinSizeMin/*/pinSizeMax/*/pinFilter/*/pageLimit/10/pageOffset/0?metadata[name]=${testName}&metadata[keyvalues]=${query}`);
    });
});
